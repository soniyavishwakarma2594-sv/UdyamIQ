...
function Signup() {
    ...
    const handleSubmit = async ()=>{
        setError("");
        try {
            const res = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$axios$29$__["default"].post("http://localhost:5000/api/auth/send-otp", {
                mobile,
                type: "signup"
            });
