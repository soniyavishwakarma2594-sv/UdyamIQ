...
function OtpVerification() {
    ...
    const inputsRef = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])([]);
    const email = "m.ebrahim112@outlook.com"; // replace dynamically later
    ...
    const handleVerify = async ()=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$axios$29$__["default"].post("http://localhost:5000/api/users/verify-otp", {
                otp: finalOtp,
                email
            });
    ...
    const handleResend = async ()=>{
        await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$axios$29$__["default"].post("http://localhost:5000/api/users/resend-otp", {
            email
        });
        alert("OTP Resent");
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b0ebc882._.js.map